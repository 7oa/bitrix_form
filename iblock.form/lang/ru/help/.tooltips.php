...
$MESS ['CORNER_RADIUS_TIP'] = "Величина радиуса, с которым будут скругляться углы блока. Укажие 0 для отключения скругления углов.";
$MESS ['DELAY_DURATION_TIP'] = "Задержка между показами слайдов. Укажие 0 для отключения автоматической смены слайдов.";
$MESS ['CYCLE_SHOW_TIP'] = "Опция имеет смысл, если задержка между сменами слайдов не равна нулю. Если опция не установлена, показ слайдов будет произведён один раз, от первого к последнему.";

$MESS ['AW_IMG_SOURCE_TIP'] = "Поле или свойство элемента, из которого будет выбрано изображение.";
$MESS ['AW_URL_SOURCE_TIP'] = "Поле или свойство элемента, из которого будет выбран URL.";

$MESS ['AW_WH_TIP'] = "Значение данного поля должно быть правильным CSS-значением.";

$MESS['FETCH_OPTIONS_TIP'] = "Будут выполнены доп. запросы к базе на получение списков значений для свойств типа \"привязка к *\". Отключить ради экономии ресурсов.";
?>